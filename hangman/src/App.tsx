...
function App() {
  ...
  return (
    ...
    >
      <div
        style={{ fontSize: "2rem", textAlign: "center", minHeight: "2.2rem" }}
      >
        {!isLoser && isWinner && <span>Winner! - Refresh to try again</span>}
        {isLoser && <span>Nice try - Refresh to try again</span>}
      </div>
